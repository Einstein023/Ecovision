...
function App() {
  ...
  return(
    <div className="bg-stone-950 h-fit w-fit">
      <header>
      <motion.nav className={`${isVisible ? primaryNavstyle.reveal : "bg-stone-950 flex justify-between items-center h-fit w-full pt-3 pb-10 px-5 hidden"}`}
  ...
  initial="hidden"
  animate="visible"
        className="font-heading text-center text-4xl md:text-8xl w-250">
          <div>{
    ...
    {text2.split("").map((char, index) => (
      ...
      >
        ...
        <div className="text-md text-center flex flex-col w-100 md:text-xl">
  ...
  }}className="my-5 flex flex-col justify-center items-center gap-3 md:flex-row ">{card.map((card, cardIndex) =>(
          <motion.div
          variants={{
    hidden: { opacity: 0, y: 100 },
    visible: { opacity: 1, y: 0 }
  }}
          key={cardIndex} className="mt-10 bg-gradient-to-br from-stone-900 to-stone-800 px-7 py-7 rounded-3xl hover:border-1 hover:border-primary-clr hover:-translate-y-6 hover:bg-primary-clr hover:shadow-lg hover:shadow-primary-clr/50 ease-in-out transition-all">
      ...
      <section id="#insights" className='pt-29 flex flex-col md:flex-row gap-10 md:gap-20 justify-center items-center'>
        ...
        <h1 className='text-5xl font-heading'><span className={gradientEffect}>Interactive</span> <div>Data Exploration</div></h1>
          ...
          transition={{duration: 0.4}}
           className='opacity-70 text-xl'>Dive deep into environmental data with our initutive visualization tools. Track carbon emissions, temperature changes, renewable energy adoption, and more.</motion.p>
          <motion.ul 
          initial="hidden"
  whileInView="visible"
  variants={{
    ...
    visible: {
      transition: {
        ...
        staggerChildren: 0.5,
          ...
          className='list-disc marker:text-primary-clr opacity-70 text-xl list-inside flex flex-col gap-1'>
            <motion.li
            variants = {{
        ...
        <div>
          ...
          className="w-400 rounded-xl backdrop-blur-md shadow-lg shadow-primary-clr/30" src="./weather.jpg" />
        </div>
      </section>
      <section className='my-50 flex items-center justify-center'>
        <div className='bg-gradient-to-br from-primary-clr/50 to-stone-900 text-center rounded-2xl py-15 px-10 flex flex-col items-center gap-7'>
          ...
          className="px-5 py-4 text-stone-950 rounded-4xl font-bold bg-gradient-to-r from-primary-clr to-secondary-clr flex items-center gap-1 hover:shadow-lg hover:shadow-primary-clr/50 hover:scale-105 transition-all">
  ...
  <footer className='border-t border-stone-900 flex items-center justify-center py-6 text-sm sm:text-base px-4'>
